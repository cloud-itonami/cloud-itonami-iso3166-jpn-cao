...
`cloud-itonami-iso3166-jpn-cao` accepts contributions to the OSS actor, governor tests,
...
- Keep production actions behind the Cross-Ministerial Compliance Governor.
- Never let the advisor state a legal/tax conclusion as fact — every
  regulatory requirement must cite the official CAO source.
